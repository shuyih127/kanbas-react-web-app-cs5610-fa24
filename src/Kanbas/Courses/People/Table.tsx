    ...
    <div id="wd-people-table">
      <table className="table table-striped">
        ...
        <tr><td className="wd-full-name text-nowrap">
            ...
            <td className="wd-login-id">111234561S</td>
            <td className="wd-section">S101</td>
            <td className="wd-role">STUDENT</td>
        ...
        <tr><td className="wd-full-name text-nowrap">
            ...
            <td className="wd-section">S101</td>
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2020-09-12</td>
            <td className="wd-total-activity">23:30:32</td> </tr>
        <tr><td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
              <span className="wd-first-name">Natasha</span>{" "}
              <span className="wd-last-name">Romanoff</span></td>
            <td className="wd-login-id">000011211S</td>
            <td className="wd-section">S101</td>
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2020-09-22</td>
            <td className="wd-total-activity">15:11:32</td> </tr>  
